...
import json
# A função show_login_form não é mais necessária aqui
...
if not aparelhos_em_uso:
    ...
    aparelho_selecionado_str = st.selectbox("Selecione o aparelho e colaborador:", options=aparelhos_dict.keys())
    ...
    with st.form("form_devolucao"):
        ...
        if submitted:
            processar_devolucao(aparelho_id, colaborador_id, checklist_data, destino_final, observacoes)
